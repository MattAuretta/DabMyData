        ...
        myChart.onclick = function (evt) {
            ...
            if (activePoints[0]) {
                ...
                $.when(
                    ...
                    $("#strain-info-body").append("<h2>Flavor: </h2>" + flavors.join(", "))
                    ...
                    $("#myModal").modal("show");
                    $("#strainInfo").text(label);
                    $("#strain-info-body").append("<h2>Positive Effects: </h2>" + pEffects.join(", ") + "<br>" + "<h2>Negative Effects: </h2>" + nEffects.join(", ") + "<br>" + "<h2>Medical Effects: </h2>" + mEffects.join(", "))
