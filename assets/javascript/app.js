...
$("#add-strain").on("click", function (event) {
    ...
    $.ajax({
        url: "https://strainapi.herokuapp.com/vij2AV1/strains/search/name/" + strain + "",
        method: "GET",
        ...
        myChart.onclick = function (evt) {
            ...
            if (activePoints[0]) {
                ...
                $.when(
                    $.ajax({
                        url: "https://strainapi.herokuapp.com/vij2AV1/strains/data/flavors/" + value + ""
                    }),
                    $.ajax({
                        url: "https://strainapi.herokuapp.com/vij2AV1/strains/data/effects/" + value + "",
                    }),
                    $.ajax({
                        url: "https://strainapi.herokuapp.com/vij2AV1/strains/data/desc/" + value + "",
                    })
